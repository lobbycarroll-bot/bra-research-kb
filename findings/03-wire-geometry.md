...
|---|---|---|
| **France** | Splayed and shallow; shorter and low at center and underarm; particularly suited to petite/small cups where classic wires are too narrow and long | **Confirmed best fit in size 36**; successful control |
...
Jimura's diagram defines **A = tip-center to tip-center span**, **B = cup depth from the tip line**, and **C = wire arc length**. The earlier reading of A/B as height/width was wrong. Dimensions below are A span × B depth; C arc length.

| Jimura number | U type: span × depth; arc | C/L type: span × depth; arc |
|---:|---:|---:|
| 65 | 105 × 64 mm; 187 mm | 108 × 53 mm; 166 mm |
| 70 | 111 × 68 mm; 199 mm | 114 × 58 mm; 180 mm |
| 75 | 116 × 72 mm; 212 mm | 120 × 63 mm; 194 mm |
| 80 | 123 × 76 mm; 224 mm | 128 × 68 mm; 208 mm |

The C page displays the same span/depth/arc table as Jimura L, but that does **not** prove the curves are interchangeable. Use the full-size outlines to compare their lower arcs and tip paths.

### Direct comparison to Jum's successful France 36

| Wire | Tip span | Cup depth | Arc | Reading |
|---|---:|---:|---:|---|
| **Emerald Erin France 36** | ~119 mm* | ~36 mm* | **172 mm published** | Very open/shallow; successful fit |
| Jimura C/L65 | 108 mm | 53 mm | 166 mm | Slightly shorter, but narrower and about 17 mm deeper |
| Jimura C/L70 | 114 mm | 58 mm | 180 mm | Similar span/arc bracket, but about 22 mm deeper |
| Jimura U65 | 105 mm | 64 mm | 187 mm | Narrower, deeper and longer; poor first hypothesis |
| BraPartsShop L no. 4 | 115 mm | 60 mm | 160 mm | Japanese-made L control; much deeper |
| BraPartsShop L no. 5 | 125 mm | 65 mm | **172 mm** | Exact arc-length match but ~29 mm deeper; demonstrates why arc alone is insufficient |

\*France span/depth are centerline estimates measured from Emerald Erin's official scaled PDF, not supplier-tabulated specifications. Measure the physical wire to confirm.

This table supports Jum's description: the successful France wire is substantially **more open and less U-shaped** than the currently documented Japanese component wires at a similar length. “L wire” in Japanese retail usually emphasizes a low center-front arm and cleavage-making path; it does not guarantee the very shallow overall curvature of France.
...
1. Record the confirmed control as **Emerald Erin France 36**; label and preserve the physical pair. Print the official France chart at 100% and verify both rulers before comparison.
...
- Because France 36 is the known-good wire, the working lesson is already that a Western specialist offers the unusually shallow/splayed geometry Jum needs. The currently documented Japanese loose wires are useful controls and may differ in spring or tip shape, but none is yet a stronger geometric candidate than France 36.
...
- Jum's reported failure mode is the opposite of the old narrow-root hypothesis: most wires feel too narrow and too U-shaped. The successful France 36 indicates an open, shallow/splayed curve.
...
- Emerald Erin France wire and 100%-scale PDF: https://shop.emeralderin.com/products/france-underwires

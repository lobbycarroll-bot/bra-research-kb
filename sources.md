...
All sources discovered across research passes. Quality rating 1–5 stars. Translated = article translated to English on bra-research.netlify.app.

---

## ⭐⭐⭐⭐⭐ Tier (Highest Quality)

| Source | Language | Type | Topic | URL | Notes |
|--------|----------|------|-------|-----|-------|
...
| Source | Language | Type | Topic | URL | Notes |
|--------|----------|------|-------|-----|-------|
| ambitionner Naver | Korean | Blog | Full/3/4/1/2 cup; open vs closed upper edge; fit failure | https://m.blog.naver.com/PostView.naver?blogId=ambitionner&logNo=220733164618 | Translated |
| 亚太服装学校 Bilibili | Chinese | Video lecture | Wire-first cup drafting; 钢圈基本型 + 罩杯基本型 | https://www.bilibili.com/video/BV1ib4y1i7Cj/ | Vocational; 13 min; wire-first method confirmed |
| Sina blog (沉默-霸主) | Chinese | Blog | Professional bra drafting; cup-from-wire method; grading | https://blog.sina.com.cn/s/blog_4400165f010127m7.html | References 《内衣纸样设计原理与实例》 |
| HEAVEN Japan | Japanese | note + YouTube | 45yr professional bra patternmaker | Search: "HEAVEN Japan ブラ" | Industry-level; search required |
| sewingladystudio 쏘잉레이디 | Korean | YouTube | Bra draping on form; Korean atelier | https://www.youtube.com/watch?v=PK1G3tIqrLk | 4.84K subs; bra draping video |
| Menuet-dance.com | Japanese | Blog | Draping soft bra from existing bra; full pipeline | https://menuet-dance.com/relax-bra/ | Ex-underwear industry maker |
| nutte.jp work order 4099 | Japanese | Marketplace | Professional C65→B65 cup-size-down alteration | https://nutte.jp/matters/4099 | Wire untouched; upper-cup seam modification |
...
| Source | Language | Type | Topic | URL | Notes |
|--------|----------|------|-------|-----|-------|
| 天衣E恋 Zhihu | Chinese | Column | Bra component anatomy; low gore for small busts | https://zhuanlan.zhihu.com/p/34795006 | Explicit: 低鸡心 for 贫乳 |
| Sparkly Sewist | English | Blog | Simple tape-line bralette draping | https://sparklysewist.com/how-to-drape-a-bralette-pattern/ | Western; same method as Asian sources |
| YouTube — 下着を作ってみよう！ | Japanese | Playlist | Japanese bra/underwear sewing series | https://www.youtube.com/playlist?list=PLvwQND68MGhGny_ET2XycZ7i4WeMFafWq | — |
| YouTube かこみ製図 bra draping | Japanese | Video | Bra block from draping + サイズダウン video | https://www.youtube.com/watch?v=wAQZ24pLqn8 | Same channel has pattern-downsizing video |
| beautefit Naver | Korean | Blog | Lingerie patternmaking courses; wire/molded cup industry | Naver blog search | Wire-first method; factory visits |
| gygbs.tistory.com | Korean | Blog | Korean A-cup corset; boning at drafting time | https://gygbs.tistory.com/entry/한복-원단과-레이스로-코르셋-만들기 | Construction-rich; no formulas |
| Wacoal SCANBE | Japanese | Retail service | Free 3D bust scan; 20+ measurements | https://www.wacoal.jp/scanbe/qa/ | Measurements only; not a form source |
| uysai.net (うさこの洋裁工房) | Japanese | Website | Free pattern drafting; bikini/bra drafting | https://yousai.net | Free; small-size coverage |
| ameblo weathersf | Japanese | Blog | Wired bra home build using Western Maya Bra pattern | https://ameblo.jp/weathersf/ | Evidence of JP home-sewing wired-bra scarcity |
| 옷짱 YouTube | Korean | YouTube | Underwear block from body measurements | Search: "옷짱 속옷 패턴" | 23K views |
| note.com kate_and_sister | Japanese | Blog | Tape-double technique for bust area | https://note.com/kate_and_sister/n/n7dd2463a45ec | Practical failure notes included |
| X yousaikoubou | Japanese | Social | Tape-double tips: ≤15cm strips, hollow handling | https://x.com/yousaikoubou/status/852729559686324225 | — |

---

## Books

| Title | Author | Language | ISBN | Quality | Notes |
|-------|--------|----------|------|---------|-------|
| 《内衣纸样设计原理与实例》 | 常建亮 | Chinese | 9787532389261 | ⭐⭐⭐⭐⭐ | Core Chinese bra textbook; 2007; out of print |
| 《内衣纸样设计原理与技巧》 | 印建荣/常建亮 | Chinese | 9787532375967 | ⭐⭐⭐⭐⭐ | More drafting-heavy companion; 2004; out of print |
| 手作りランジェリー No.1404 | — | Japanese | 4834714047 | ⭐⭐⭐ | Boutique-sha; some drafting; reviewer: trace from old bra |

---

## Pattern Companies

| Brand | Language | Type | Small-size? | URL | Notes |
|-------|----------|------|-------------|-----|-------|
| Pinup Girls (Beverly Johnson) | English | Wired bra patterns | Yes (Sweet Sixteen for shallow) | https://www.pinupgirlspatterns.com | Referenced by Korean/JP sources as Western standard |
...
## Retail Bras (34AA / Small Frame Reference)

| Brand | Country | Why useful | Small-size? | URL |
|-------|---------|-----------|-------------|-----|
| Pepper | US | Small-bust only brand; wire geometry reference | AA–B | https://www.pepperbra.com |
